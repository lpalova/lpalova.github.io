...
I created a simple predictor app
...
across states due to the eight different event types. Feel free to 
[try it out](http://ec2-54-173-233-196.compute-1.amazonaws.com/map_predictor/) !
<img src="/images/Storms/simple_predictor_app.png" width="450" height="250" />

Lastly, here is a [slide deck](https://docs.google.com/presentation/d/1uSIFORCHXLeSqNanSpRr9VIMAkclPoNNYD00efeqypg/edit#slide=id.g10f7417bd3_0_19) on some of my findings and 
a [source code](https://github.com/lpalova/Storm-Events-Classification).
